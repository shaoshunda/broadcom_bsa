...
#define BSA_AVK_STR_OPEN_EVT     6       /* stream channel opened */
#define BSA_AVK_STR_CLOSE_EVT    7       /* stream channel closed */
...
#define BSA_MAX_AVK_CONNECTIONS    BTA_AVK_MAX_NUM_CONN
...
/* AVK streaming channel open */
/* data associated with BSA_AVK_STR_OPEN_MSG */
typedef struct
{
    tBSA_STATUS     status;
    BD_ADDR         bd_addr;
    UINT8           ccb_handle;
    BOOLEAN         starting;
} tBSA_AVK_STR_OPEN_MSG;

/* AVK streaming channel closed */
/* data associated with BSA_AVK_STR_CLOSE_MSG */
typedef struct
{
    tBSA_STATUS     status;
    BD_ADDR         bd_addr;
    UINT8           ccb_handle;
} tBSA_AVK_STR_CLOSE_MSG;
...
/* AVK stop streaming */
/* data associated with BSA_AVK_STOP_MSG */
typedef struct
{
    tBSA_STATUS  status;
    BD_ADDR         bd_addr;
...
typedef union
{
    tBSA_AVK_OPEN_MSG sig_chnl_open;
    tBSA_AVK_CLOSE_MSG sig_chnl_close;
    tBSA_AVK_STR_OPEN_MSG stream_chnl_open;
    tBSA_AVK_STR_CLOSE_MSG stream_chnl_close;
    tBSA_AVK_START_MSG start_streaming;
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkSetAbsVolumeRspInit(tBSA_AVK_SET_ABS_VOLUME_RSP *pAbsVol);
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkSetAbsVolumeRsp(tBSA_AVK_SET_ABS_VOLUME_RSP *pAbsVol);
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkRegNotifRspInit(tBSA_AVK_REG_NOTIF_RSP *pRegNotf);
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkRegNotifRsp(tBSA_AVK_REG_NOTIF_RSP *pRegNotf);
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkCloseStrInit(tBSA_AVK_CLOSE_STR *pCloseStr);
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkCloseStr(tBSA_AVK_CLOSE_STR *pCloseStr);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkRemoteRspInit(tBSA_AVK_REM_RSP *pRemRsp);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkRemoteRsp(tBSA_AVK_REM_RSP *pRemRsp);
