...
#ifndef BSA_BLE_CLIENT_SECURITY
#define BSA_BLE_CLIENT_SECURITY         BTA_DM_BLE_SEC_NONE
#endif
...
#define BSA_BLE_MAX_PDU_LENGTH                              251
...
typedef enum
{
    ...
    BSA_BLE_CL_CFG_MTU_EVT,       /* configure MTU complete event */
...
/* callback event data for BSA_BLE_CL_CFG_MTU_EVT event */
typedef struct
{
    tBSA_STATUS         status;
    UINT16              conn_id;
    UINT16              mtu;
} tBSA_BLE_CL_CFG_MTU_MSG;
...
typedef union
{
    ...
    tBSA_BLE_CL_CFG_MTU_MSG      cli_cfg_mtu;       /* BSA_BLE_CL_CFG_MTU_EVT */
    ...
    tBSA_BLE_SE_STOP_MSG         ser_stop;          /* BSA_BLE_SE_STOP_EVT */
...
typedef struct
{
    ...
    UINT16              handle;     /* attribute handle */
    /* attribute value offset, if no offfset is needed for the command, ignore it */
    UINT16              offset;
    UINT16              len;        /* length of attribute value */
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_BleClCfgMtuInit(tBSA_BLE_CL_CFG_MTU *p_cfg);

/*******************************************************************************
 **
 ** Function         BSA_BleClCfgMtu
 **
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_BleClCfgMtu(tBSA_BLE_CL_CFG_MTU *p_cfg);
...
/*******************************************************************************
 **
 ** Function         BSA_BleSeStopServiceInit
 **
 ** Description      Initialize structure containing API parameters with default values
 **
 ** Parameters       Pointer on structure containing API parameters
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_BleSeStopServiceInit(tBSA_BLE_SE_STOP *p_stop);

/*******************************************************************************
 **
 ** Function         BSA_BleSeStopService
 **
 ** Description      Stop BLE service
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_BleSeStopService(tBSA_BLE_SE_STOP *p_stop);
